     ...
     $.ajax({
      ...
      success: function(result){
        ...
        for (var i = 0; i<parseInt(result.articles.length); i++) {
          ...
          art_description = ((result.articles[i].description.length>100)?(result.articles[i].description.substr(0,100)):(result.articles[i].description))+"...";
          ...
          html = '<div style="margin:0 10px">'
                    ...
                    +'<div class= "row article">'
                      +'<div class="col-xs-3"><img src="'+art_img_url+'"></div>'
                      +'<div class="col-xs-9">'
                          +'<h5><strong>'+art_title+'</strong></h5>'
                          +'<p style="font-size: 13px">'+art_description+'</p>'
                          +'<p style="font-size: 12px;padding:0 0;margin:0 0">'+art_publish_date+" | "+art_source_name+'</p>'
                      +'</div>'
                   +'</div>'
                  +'</a>'
